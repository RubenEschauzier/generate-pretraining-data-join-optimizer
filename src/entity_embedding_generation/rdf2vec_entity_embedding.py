...
def rdf2vec_embedding(num_sim_pred, num_sim_subj, num_sim_obj, depth_walk, datasetLocation, outputLocation,
                      save_model=True):
...
def main_rdf2vec(num_sim_pred, num_sim_subj, num_sim_obj, depth_walk, instantiation_benchmark_location,
    ...
    rdf2vec_embedding(num_sim_pred, num_sim_subj, num_sim_obj, depth_walk, instantiation_benchmark_location,
                      vector_save_location.format(depth_walk),
                      True)
